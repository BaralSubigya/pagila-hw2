# pagila-hw2 [![workflow status](https://github.com/BaralSubigya/pagila-hw2/actions/workflows/tests.yml/badge.svg)](https://github.com/BaralSubigya/pagila-hw2/actions/workflows/tests.yml)
